...
for i in range(episodes):
    ...
    while True:
        ...
        if done or step_count == 150:              # episode termination
            ...
            break
        step_count += 1
    # Stop and save the model when the average score of the last 30 times is greater than termination score
    current_mean = np.mean(score_list[-50:])       # calculate the mean of the last 35 scores
